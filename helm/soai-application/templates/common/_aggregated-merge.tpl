{{- define "soai-application.aggregatedMerge" -}}
{{- $merged := dict -}}
{{- $context := .context -}}
{{- $location := .location -}}
...
{{- define "soai-application.mergeAnnotations" -}}
    {{- include "soai-application.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "soai-application.mergeLabels" -}}
    {{- include "soai-application.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}