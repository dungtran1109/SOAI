...
import { Col, Container, Row } from '../responsives';
import { FiFacebook, FiMail, FiPhone } from 'react-icons/fi';
import classNames from 'classnames/bind';
import styles from '../../assets/styles/suppliers/footer.module.scss';
...
const Footer = () => {
    return (
        <div id="footer" className={cx('footer-frame')}>
            <footer className={cx('footer')}>
                    ...
                    <Row space={10}>
                        <Col size={{ xs: 0, sm: 0, md: 6, lg: 3, xl: 3 }} className={cx('footer-col')}>
                            <div className={cx('footer-col__content', 'footer-col__content--logo-center')}>
                                ...
                                <h2 className={cx('footer-col__content-title')}>Shell Apps</h2>
                            </div>
                        </Col>
                ...
                <p className={cx('footer__endline')}>2025 💖 Shell App for Company</p>
            </footer>
        </div>
    );
};
