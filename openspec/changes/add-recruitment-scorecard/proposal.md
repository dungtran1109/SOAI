...
### Auto-Fill Scope (New)
- Auto-fill a scorecard proposal via a single multipart upload API that accepts multiple artifacts together: JD (TXT/PDF/DOCX), scorecard template (TXT/PDF/DOCX), interview transcription (TXT/PDF/DOCX/VTT), and optional grade payload (JSON).
